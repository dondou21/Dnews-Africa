    ...
    <tr>
      <td align="center" style="padding:40px 20px;">
        <table role="presentation" width="560" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:4px;overflow:hidden;">
          ...
          <tr>
            <td style="padding:40px 40px 20px;">
              <h2 style="color:#1a1a2e;font-size:20px;margin:0 0 16px;">Welcome to Dnews Africa</h2>
              <p style="color:#666666;font-size:15px;line-height:1.6;margin:0 0 8px;">${greeting}</p>
              <p style="color:#666666;font-size:15px;line-height:1.6;margin:0 0 24px;">
                Thank you for joining our community. You're now confirmed and will start receiving the latest African stories, exclusive insights, and weekly editor picks delivered directly to your inbox.
              </p>
              <table role="presentation" cellpadding="0" cellspacing="0" style="margin:0 auto 32px;">
                <tr>
                  <td align="center" style="background-color:#c0392b;border-radius:4px;padding:0;">
                    <a href="https://dnewsafrica.com" target="_blank" style="display:inline-block;padding:14px 36px;color:#ffffff;text-decoration:none;font-size:15px;font-weight:600;letter-spacing:0.5px;">
                      Visit Dnews Africa
                    </a>
                  </td>
                </tr>
