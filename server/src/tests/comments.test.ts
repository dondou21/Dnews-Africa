...
describe("POST /api/articles/:id/comments", () => {
  ...
  it("should reject comment on non-existent article", async () => {
    const res = await request(app)
      .post("/api/articles/00000000-0000-0000-0000-000000000000/comments")
      .send({
        name: "Jane Doe",
        email: "jane@example.com",
        content: "Great article!",
...
describe("Moderation: GET /api/comments/pending", () => {
...
describe("Moderation: PATCH /api/comments/:id", () => {
...
describe("Moderation: DELETE /api/comments/:id", () => {
  let commentId: string;
